package top.lirchis.util.comment;
...
import top.lirchis.constant.PageConstants;
...
import top.lirchis.util.HashUtils;
import top.lirchis.util.IpAddressUtils;
import top.lirchis.util.MailUtils;
import top.lirchis.util.QQInfoUtils;
import top.lirchis.util.StringUtils;
import top.lirchis.util.comment.channel.ChannelFactory;
import top.lirchis.util.comment.channel.CommentNotifyChannel;
import top.lirchis.enums.CommentOpenStateEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.lirchis.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.lirchis.entity.Comment parentComment, Comment comment) {
