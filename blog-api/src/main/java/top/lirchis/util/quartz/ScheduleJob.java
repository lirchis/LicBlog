package top.lirchis.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.lirchis.entity.ScheduleJobLog;
import top.lirchis.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.lirchis.entity.ScheduleJob scheduleJob = (top.lirchis.entity.ScheduleJob) context.getMergedJobDataMap().get(top.lirchis.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
