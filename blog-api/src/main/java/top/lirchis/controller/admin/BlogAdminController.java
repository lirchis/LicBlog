...
import top.lirchis.service.CommentService;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.lirchis.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.lirchis.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.lirchis.model.dto.Blog blog, String type) {
		//验证普通字段
